				...
				<section class="navigate">
					<div class="navigate__container _container">
						<div class="navigate__inner">
							...
							<p>/</p>
							<a href="#" class="navigate__link">Каталог</a>
							<p>/</p>
									...
									<div class="filter-category__links links-filter">
										<ul data-spollers="0,min" class="links-filter__list">
											<li class="links-filter__item">
												<a href="<? echo get_term_link($argssub["5"]->slug, 'product_cat');  ?>" class="links-filter__link"><? echo $argssub["5"]->name; ?></a>
											</li>
											<li class="links-filter__item links-filter__spoller">
												<button data-spoller class="links-filter__spoller-btn _icon-arrow-right">Столы и стулья</button>
												<ul>
													<li>
														<a href="<? echo get_term_link($argssub["7"]->slug, 'product_cat');  ?>"><? echo $argssub["7"]->name; ?></a>
													</li>
													<li>
														<a href="<? echo get_term_link($argssub["8"]->slug, 'product_cat');  ?>"><? echo $argssub["8"]->name; ?></a>
													</li>
													<li>
														<a href="<? echo get_term_link($argssub["9"]->slug, 'product_cat');  ?>"><? echo $argssub["9"]->name; ?></a>
													</li>
													
												</ul>
											</li>
											<li class="links-filter__item links-filter__spoller">
												<button data-spoller class="links-filter__spoller-btn _icon-arrow-right">Тумбы и комоды</button>
												<ul>
													<li>
														<a href="<? echo get_term_link($argssub["6"]->slug, 'product_cat');  ?>"><? echo $argssub["6"]->name; ?></a>
													</li>
														<li>
														<a href="<? echo get_term_link($argssub["15"]->slug, 'product_cat');  ?>"><? echo $argssub["15"]->name; ?></a>
													</li>
														<li>
														<a href="<? echo get_term_link($argssub["4"]->slug, 'product_cat');  ?>"><? echo $argssub["4"]->name; ?></a>
													</li>
														<li>
														<a href="<? echo get_term_link($argssub["17"]->slug, 'product_cat');  ?>"><? echo $argssub["17"]->name; ?></a>
													</li>
												</ul>
											</li>
											<li class="links-filter__item">
												<a href="<? echo get_term_link($argssub["12"]->slug, 'product_cat');  ?>" class="links-filter__link"><? echo $argssub["12"]->name; ?></a>
											</li>
											<li class="links-filter__item">
											     <a href=" <? echo get_term_link($argssub["3"]->slug, 'product_cat');  ?>" class="links-filter__link"><? echo $argssub["3"]->name; ?></a>
											</li>
											<li class="links-filter__item">
												<a href=" <? echo get_term_link($argssub["18"]->slug, 'product_cat');  ?>" class="links-filter__link"><? echo $argssub["18"]->name; ?></a>
											</li>
										    <li class="links-filter__item">
												<a href=" <? echo get_term_link($argssub["10"]->slug, 'product_cat');  ?>" class="links-filter__link"><? echo $argssub["10"]->name; ?></a>
											</li>
											<li class="links-filter__item">
												<a href=" <? echo get_term_link($argssub["2"]->slug, 'product_cat');  ?>" class="links-filter__link"><? echo $argssub["2"]->name; ?></a>
											</li>
										</ul>
									</div>
									...
									<div class="filter-category__options">
										...
										<div class="filter-category__price">
											...
											<div class="filter-category__price-inputs">
												...
												<input autocomplete="off" type="text" name="price2" data-error="Ошибка" data-value="До" class="input">
											</div>
										...
										<div class="filter-category__style">
											...
											<label class="filter-category__style-item <?php echo isset($_GET['styles']) && array_search("style1",$_GET['styles'],true) !== false ? "_active" : "" ?>">
												<input type="checkbox" hidden <?php isset($_GET['styles']) && $_GET['styles'] == 'style1' ? "checked" : "" ?> name="styles[]" value="style1">
											...
											<label class="filter-category__style-item <?php echo isset($_GET['styles']) && array_search("style2",$_GET['styles'],true) !== false ? "_active" : "" ?>">
												<input type="checkbox" hidden <?php isset($_GET['styles']) && $_GET['styles'] == 'style2' ? "checked" : "" ?> name="styles[]" value="style2">
												<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M10.6978 1.00269C10.938 1.18094 10.9883 1.5202 10.81 1.76045L4.58084 10.1563C4.48116 10.2906 4.325 10.3714 4.15775 10.3751C3.9905 10.3787 3.83093 10.3049 3.72544 10.1751L0.204602 5.84177C0.0159575 5.60959 0.0512483 5.26845 0.283426 5.0798C0.515604 4.89116 0.856748 4.92645 1.04539 5.15863L4.12641 8.95064L9.93999 1.11495C10.1182 0.874696 10.4575 0.824435 10.6978 1.00269Z" fill="#333333"/>
													</svg></span>
												<p>Скандинавский</p>
											</label>
											<label class="filter-category__style-item <?php echo isset($_GET['styles']) && array_search("style3",$_GET['styles'],true) !== false ? "_active" : "" ?>">
												<input type="checkbox" hidden <?php isset($_GET['styles']) && $_GET['styles'] == 'style3' ? "checked" : "" ?> name="styles[]" value="style3">
												<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M10.6978 1.00269C10.938 1.18094 10.9883 1.5202 10.81 1.76045L4.58084 10.1563C4.48116 10.2906 4.325 10.3714 4.15775 10.3751C3.9905 10.3787 3.83093 10.3049 3.72544 10.1751L0.204602 5.84177C0.0159575 5.60959 0.0512483 5.26845 0.283426 5.0798C0.515604 4.89116 0.856748 4.92645 1.04539 5.15863L4.12641 8.95064L9.93999 1.11495C10.1182 0.874696 10.4575 0.824435 10.6978 1.00269Z" fill="#333333"/>
													</svg></span>
												<p>Рустика кантри</p>
											</label>
											<label class="filter-category__style-item <?php echo isset($_GET['styles']) && array_search("style4",$_GET['styles'],true) !== false ? "_active" : "" ?>">
												<input type="checkbox" hidden <?php isset($_GET['styles']) && $_GET['styles'] == 'style4' ? "checked" : "" ?> name="styles[]" value="style4">
												<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M10.6978 1.00269C10.938 1.18094 10.9883 1.5202 10.81 1.76045L4.58084 10.1563C4.48116 10.2906 4.325 10.3714 4.15775 10.3751C3.9905 10.3787 3.83093 10.3049 3.72544 10.1751L0.204602 5.84177C0.0159575 5.60959 0.0512483 5.26845 0.283426 5.0798C0.515604 4.89116 0.856748 4.92645 1.04539 5.15863L4.12641 8.95064L9.93999 1.11495C10.1182 0.874696 10.4575 0.824435 10.6978 1.00269Z" fill="#333333"/>
													</svg></span>
												<p>Винтажный</p>
											</label>
											<label class="filter-category__style-item <?php echo isset($_GET['styles']) && array_search("style5",$_GET['styles'],true) !== false ? "_active" : "" ?>">
												<input type="checkbox" hidden <?php isset($_GET['styles']) && $_GET['styles'] == 'style5' ? "checked" : "" ?> name="styles[]" value="style5">
												<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M10.6978 1.00269C10.938 1.18094 10.9883 1.5202 10.81 1.76045L4.58084 10.1563C4.48116 10.2906 4.325 10.3714 4.15775 10.3751C3.9905 10.3787 3.83093 10.3049 3.72544 10.1751L0.204602 5.84177C0.0159575 5.60959 0.0512483 5.26845 0.283426 5.0798C0.515604 4.89116 0.856748 4.92645 1.04539 5.15863L4.12641 8.95064L9.93999 1.11495C10.1182 0.874696 10.4575 0.824435 10.6978 1.00269Z" fill="#333333"/>
													</svg></span>
												<p>Лофт</p>
											</label>
											<label class="filter-category__style-item <?php echo isset($_GET['styles']) && array_search("style6",$_GET['styles'],true) !== false ? "_active" : "" ?>">
												<input type="checkbox" hidden <?php isset($_GET['styles']) && $_GET['styles'] == 'style6' ? "checked" : "" ?> name="styles[]" value="style6">
												<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M10.6978 1.00269C10.938 1.18094 10.9883 1.5202 10.81 1.76045L4.58084 10.1563C4.48116 10.2906 4.325 10.3714 4.15775 10.3751C3.9905 10.3787 3.83093 10.3049 3.72544 10.1751L0.204602 5.84177C0.0159575 5.60959 0.0512483 5.26845 0.283426 5.0798C0.515604 4.89116 0.856748 4.92645 1.04539 5.15863L4.12641 8.95064L9.93999 1.11495C10.1182 0.874696 10.4575 0.824435 10.6978 1.00269Z" fill="#333333"/>
													</svg></span>
												<p>Восточный</p>
										...
										<div class="filter-category__count">
											<p>Найдено <?php  echo $_SESSION["count"];?> товара</p>
											<button type="button">
                                    ...
                                    <!-- <form action="" method="get"> -->
										...
										<div class="content-category__keys">
											...
											<div class="content-category__keys-item" style="<?php echo isset($_GET['x_index2']) ? "" : "display:none" ?>">
												<p>Ширина:  <?= $_GET['x_index1']."-".$_GET['x_index2'] ?> см</p>
												<button type="button">
													<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.79822 10.5643C10.0098 10.7758 10.3527 10.7758 10.5643 10.5643C10.7758 10.3527 10.7758 10.0098 10.5643 9.79822L8.26616 7.50013L10.5643 5.20204C10.7758 4.9905 10.7758 4.64754 10.5643 4.43601C10.3527 4.22447 10.0098 4.22447 9.79822 4.43601L7.50013 6.7341L5.20203 4.43599C4.99049 4.22446 4.64753 4.22446 4.43599 4.43599C4.22446 4.64753 4.22446 4.99049 4.43599 5.20203L6.7341 7.50013L4.43599 9.79823C4.22446 10.0098 4.22446 10.3527 4.43599 10.5643C4.64753 10.7758 4.99049 10.7758 5.20203 10.5643L7.50013 8.26616L9.79822 10.5643Z" fill="#999999"/></svg>												
												</button>
											</div>
											<div class="content-category__keys-item" style="<?php echo isset($_GET['y_index2']) && isset($_GET['y_index1']) ? "" : "display:none" ?>">
												<p>Высота: <?= $_GET['y_index1']."-".$_GET['y_index2'] ?>см</p>
												<button type="button">
													<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.79822 10.5643C10.0098 10.7758 10.3527 10.7758 10.5643 10.5643C10.7758 10.3527 10.7758 10.0098 10.5643 9.79822L8.26616 7.50013L10.5643 5.20204C10.7758 4.9905 10.7758 4.64754 10.5643 4.43601C10.3527 4.22447 10.0098 4.22447 9.79822 4.43601L7.50013 6.7341L5.20203 4.43599C4.99049 4.22446 4.64753 4.22446 4.43599 4.43599C4.22446 4.64753 4.22446 4.99049 4.43599 5.20203L6.7341 7.50013L4.43599 9.79823C4.22446 10.0098 4.22446 10.3527 4.43599 10.5643C4.64753 10.7758 4.99049 10.7758 5.20203 10.5643L7.50013 8.26616L9.79822 10.5643Z" fill="#999999"/></svg>												
												</button>
											</div>
                                            <div class="content-category__keys-item"  style="<?php echo isset($_GET['z_index2']) && isset($_GET['z_index1']) ? "" : "display:none" ?>">
												<p>Глубина: <?= $_GET['z_index1']."-".$_GET['z_index2'] ?> см</p>
												<button type="button">
													<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.79822 10.5643C10.0098 10.7758 10.3527 10.7758 10.5643 10.5643C10.7758 10.3527 10.7758 10.0098 10.5643 9.79822L8.26616 7.50013L10.5643 5.20204C10.7758 4.9905 10.7758 4.64754 10.5643 4.43601C10.3527 4.22447 10.0098 4.22447 9.79822 4.43601L7.50013 6.7341L5.20203 4.43599C4.99049 4.22446 4.64753 4.22446 4.43599 4.43599C4.22446 4.64753 4.22446 4.99049 4.43599 5.20203L6.7341 7.50013L4.43599 9.79823C4.22446 10.0098 4.22446 10.3527 4.43599 10.5643C4.64753 10.7758 4.99049 10.7758 5.20203 10.5643L7.50013 8.26616L9.79822 10.5643Z" fill="#999999"/></svg>												
												</button>
											</div>
                        ...
                        ?>
                                    ...
                                    <div class="favorite__item item-favorite">
                                        ...
                                        <div class="favorite__slide-buttons">
                                            ...
                                            <button type="button" class="favorite__slide-cartBtn _icon-cart add_cart" name="<? echo  $product_id ;?>">В корзину</button>
                                        </div>
                                    </div>
